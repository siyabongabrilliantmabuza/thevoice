...
-- CreateIndex
CREATE INDEX "Interest_interestedInId_idx" ON "Interest"("interestedInId");

-- CreateIndex
CREATE UNIQUE INDEX "Interest_userId_interestedInId_key" ON "Interest"("userId", "interestedInId");
...
-- AddForeignKey
ALTER TABLE "Interest" ADD CONSTRAINT "Interest_interestedInId_fkey" FOREIGN KEY ("interestedInId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
